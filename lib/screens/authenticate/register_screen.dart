...
class RegisterScreen extends StatefulWidget {
  ...
  const RegisterScreen(
      {Key? key, required this.formKey, required this.signInCallback})
      : super(key: key);
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void registerUser() async {
    ...
    if (res.statusCode == 200) {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => Frame(id: json['id'])));
                ...
                child: Form(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      textField(
                          '_displayName', 'Display Name', false, _displayName),
                      textField('_email', 'Email', false, _email),
                      textField('_password', 'Password', true, _password),
                      textField('_verifyPassword', 'Confirm Password', true,
                          _verifyPassword),
                      Visibility(
                        visible: _error != null,
                        child: Center(
  ...
  Widget textField(
      String? val, String hintText, bool obscureText, String? initialValue) {
    return Padding(
